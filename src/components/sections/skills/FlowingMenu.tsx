...
const FlowingMenu: React.FC<{ items: SkillCategory[], speed?: number, marqueeBgColor?: string }> = ({
...
const MenuItem: React.FC<SkillCategory & { speed: number; marqueeBgColor: string; isFirst: boolean }> = ({
